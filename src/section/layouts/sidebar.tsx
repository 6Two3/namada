                ...
                <ul className="flex flex-col">
                    {links.map((link, index) => (
                        <li key={index}>
                            <Link
                                href={link.url}
                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-black dark:text-white duration-300 ease-in-out hover:bg-graydark dark:hover:bg-gray2 ${pathname === link.url &&
                    ...
                    {socialIcons.map((icon, index) => (
                        <Link href={icon.url} key={index}>
                            <Image
                                ...
                                height={20}
                                style={{
                                    filter: theme === "dark" && (icon.title === "twitter" || icon.title === "github")
                                        ? "invert(70%)"
                                        : "",
                                }}
                            />

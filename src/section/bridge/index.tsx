      ...
      <div className="flex flex-col border border-graydark dark:border-gray2 rounded-lg p-8 gap-5 w-full max-w-[600px]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[#868e96] text-sm font-light">
            The Namada Foundation is not responsible for the operation or
            security of third-party bridge services. Use at your own risk. By
            using this link you expressly indemnify and hold Namada and its
            Affiliates harmless for any loss or damage incurred.
          </p>
        </div>
      </div>
    </div>
